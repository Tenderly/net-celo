...
import (
	...
	"github.com/tenderly/net-celo/internal/download"
...
func buildFlags(env build.Environment, staticLinking bool, buildTags []string) (flags []string) {
	...
	if env.Commit != "" {
		ld = append(ld, "-X", "github.com/tenderly/net-celo/internal/version.gitCommit="+env.Commit)
		ld = append(ld, "-X", "github.com/tenderly/net-celo/internal/version.gitDate="+env.Date)
	}
	if env.Tag != "" {
		ld = append(ld, "-X", "github.com/tenderly/net-celo/version.gitTag="+env.Tag)
	}
...
func doCheckBadDeps() {
	baddeps := [][2]string{
		...
		{"github.com/tenderly/net-celo/core/rawdb", "github.com/tenderly/net-celo/ethdb/leveldb"},
		{"github.com/tenderly/net-celo/core/rawdb", "github.com/tenderly/net-celo/ethdb/pebbledb"},
	}
	tc := new(build.GoToolchain)
